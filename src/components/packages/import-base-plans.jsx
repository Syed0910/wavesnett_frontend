...
const ImportBasePlans = () => {
  ...
  const handleSampleDownload = () => {
    ...
    const sampleData = "Plan Name,Bandwidth,Quota,Type\n100Mbps,100M/100M,3500G,Fup\n200Mbps,200M/200M,3500G,Fup";
...
export default ImportBasePlans;